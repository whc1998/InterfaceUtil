...
public class FouthFragment extends BaseFragment {
    ...
    public static final String ResultAndParam = FouthFragment.class.getName() + "ResultAndParam";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String s = functionManager.invokeFunction(ResultAndParam, String.class, 520);
